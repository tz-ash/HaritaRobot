...
about = "**About Me**\n\nMy name is Axia, A powerful group management bot who can take care of your groups with automated simple regular admin actions!\n\n**My Software Version:** 2.0.1\n**Telethon Version:** 1.21.1\n\n**My Developers:**\n• @Eviral\n• @Denzid\n• @wbavishek\n\nUpdates Channel: [Click Here](t.me/psykd)\nSupport Chat: [Click Here](t.me/magiclmush)\n\nAnd finally thanks for Supporting me😘"
ad_caption = "Hey! I am Axia, here to help you manage your groups! I perform most of the admin functions and make your group automated!\n\nJoin @psykd for updates.\n@kid_of_telegram for help and support\n\nYou can checkout more about me via following buttons."
pm_caption = "Hey there! My name is Axia - I'm a powerful group management bot Made to help you manage your groups easily!\n\nHit /help to find out more about me and unleash my full potential.\n\n"
pmt = "Hello there! I'm Axia\nI'm a Telethon Based group management bot\n with a Much More features! Have a look\nat the following for an idea of some of \nthe things I can help you with.\n\nMain commands available:\n/start : Starts me, can be used to check i'm alive or not.\n/help : PM's you this message.\nExplore My Commands🙃."
        ...
        await tbot.send_message(
            ...
            buttons=[
                [
                  ...
                  [
                    Button.url(
                        "Add Me To Your Group!", "t.me/AxiaXbot?startgroup=true"
                    ),
                ],
            ],
        )
    else:
        await event.reply("Heya Axia is here!,\nHow Can I Help Ya.")
...
async def help(event):
    if not event.is_group:
        ...
        await event.reply(
            ...
            buttons=[[Button.url("Click me for help!", "t.me/AxiaXbot?start=help")]],
        )
...
def paginate_help(event, page_number, loaded_plugins, prefix):
    ...
    pairs = pairs[
            ...
            (
                ...
                custom.Button.url(
                    "Source", "https://github.com/tz-ash/Axia"
                ),
